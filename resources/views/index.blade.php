                        ...
                        <div class="col-lg-6">
                            <div class="card card-custom h-100 p-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route(name: 'delete', parameters: $post) }}" method="POST" style="display:inline"
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card card-custom p-3 h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-auto">
                                    <a href="{{ route('show', $post) }}" class="btn btn-secondary btn-sm">View</a>
                                    <a href="{{ route(name: 'edit', parameters: $post) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <form action="{{ route(name: 'delete', parameters: $post) }}" method="POST" style="display:inline"
                                        onsubmit="return confirm('Are you sure you want to delete this post?');">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-2-4">
                                <div class="card card-custom p-3 h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-auto">
                                            <a href="{{ route('show', $post) }}" class="btn btn-secondary btn-sm">View</a>
                                            <a href="{{ route(name: 'edit', parameters: $post) }}"
                                                class="btn btn-warning btn-sm">Edit</a>
                                            <form action="{{ route(name: 'delete', parameters: $post) }}" method="POST"
